...
public class B14ObjectTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\t ob1 toString = " + ob1.toString()); // String은 toSting 재정의
        System.out.println("\t ob2 toString = " + ob2.toString()); // Object toString의 기본값 출력
        System.out.println("\t ob3 toString = " + ob3.toString()); // Integr는 toSting 재정의

        System.out.println("\t ob1 toString = " + ob1); // toString 메소드는 생략하고 쓸수 있습니다.
