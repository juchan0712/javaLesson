...
public class B04CartMain {
    ...
    public static void main(String[] args) {
        ...
        Cart momos_cart = new Cart(); // String, String[], int[] 필드는 null 상태

        // 모모의 장바구니 - 상품이름, 가격
        String[] products = { "새우깡", "칠성사이다", "빅토리아", "제주감귤", "나주배" };
        int[] prices = { 3000, 2500, 9900, 12000, 9800 };
        ...
        //System.out.println("모모 님이 선택하신 상품 가격 합계 : " + momos_cart.total_Money(select));
