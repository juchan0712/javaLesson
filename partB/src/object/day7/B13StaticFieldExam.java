...
public class B13StaticFieldExam {
    ...
    // Character
    System.out.println("\nCharacter_VALUE = " + Character.MAX_VALUE);
    System.out.println("\nCharacter_VALUE = " + (int)Character.MAX_VALUE);
    ...
    System.out.println("Triangle.MAX_WIDTH = " + Triangle.MAX_WIDTH);   // 90
    }
}
/*
 ...
 * 
 * 위의 2가지 경우보다는 의미상 조합이 public static final이 맞습니다.
