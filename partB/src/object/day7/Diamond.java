...
public class Diamond extends Shape{
   ...
   /*  public void setShapeName(String shapeName){
    ...
    public void iAmDiamond() {
        System.out.println("나는 다이아본드 ~ 반짝반짝");
    }

    //day8 내용 : Object 클래스의 toString 메소드를 오버라이드
    //                  ㄴ object.day7.Diamond@1fb3ebeb 가 기본인 것을 다른 문자열로 바꿈. 
    @Override
 ...
 *                      ㄴ Shape의 etc는 자식인 Triangle, Diamond 에게는 공개 / 같은 패키지 B10DiamondTest 에게도 공개
