...
public class B07ConstructorExam {
    ...
    public static void main(String[] args) {
        ...
        // 문자열 객체 생성하기
        // 1) 메소드 오버로딩 : 메소드 이름 같으면서 인자의 개수와 형식을 다르게 정의합니다.
        ...
        // 2) 문자열 리터럴 특징 : 문자열 내용이 같으면 또 메모리에 새로 저장하지 않고 
        // message가 참조하는 "Hello~"와 동일한 리터럴을 temp가 참조할 때, "Hello~"를 또 저장해서 temp 참조하지 않고 이미 저장되어 있는 "Hello~" 참조
        ...
        System.out.println("message == temp ? " + (message == temp)); // 참조값 비교. 그러므로 , message 와 temp는 기억장소 동일 => true
        ...
        //                  ㄴInputStream 클래스로 만들어진 객체 System.in 을 생성자 인자로 하여 객체를 생성
        ...
        System.out.println("위의 입력 테스트에서 nextInt 또는 nextDouble은 엔터처리를 안하므로 다음에 나오는 nextLine 으로 자동 저장");
